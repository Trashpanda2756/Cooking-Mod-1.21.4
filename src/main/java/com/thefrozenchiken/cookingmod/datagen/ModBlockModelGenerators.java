...
public class ModBlockModelGenerators extends BlockModelGenerators {
    ...
    final List<Block> nonOrientableTrapdoor = ImmutableList.of(Blocks.OAK_TRAPDOOR, Blocks.DARK_OAK_TRAPDOOR, Blocks.IRON_TRAPDOOR /* , ModBlocks.Modded_Trapdoor.get() */);
    ...
    public void run() {
        ...
        createTrivialCube(ModBlocks.MOD_BLOCK.get());
    }
